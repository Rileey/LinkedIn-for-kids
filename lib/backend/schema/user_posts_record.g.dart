    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'postOwner':
          ...
          break;
        case 'projectProfile':
          result.projectProfile = serializers.deserialize(value,
                  specifiedType: const FullType(
                      DocumentReference, const [const FullType(Object)]))
              as DocumentReference<Object>;
          break;
        case 'postPhotos':
          result.postPhotos = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
...
class _$UserPostsRecord extends UserPostsRecord {
  ...
  @override
  final DocumentReference<Object> projectProfile;
  @override
  final String postPhotos;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is UserPostsRecord &&
        ...
        projectProfile == other.projectProfile &&
        postPhotos == other.postPhotos &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper('UserPostsRecord')
          ...
          ..add('projectProfile', projectProfile)
          ..add('postPhotos', postPhotos)
...
class UserPostsRecordBuilder
  ...
  DocumentReference<Object> _projectProfile;
  DocumentReference<Object> get projectProfile => _$this._projectProfile;
  set projectProfile(DocumentReference<Object> projectProfile) =>
      _$this._projectProfile = projectProfile;

  String _postPhotos;
  String get postPhotos => _$this._postPhotos;
  set postPhotos(String postPhotos) => _$this._postPhotos = postPhotos;
  ...
  UserPostsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _projectProfile = $v.projectProfile;
      _postPhotos = $v.postPhotos;
