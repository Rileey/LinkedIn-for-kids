                    ...
                    child: Column(
                      children: [
                        TabBar(
                          ...
                          unselectedLabelColor: Color(0xFF414343),
                                ...
                                child: StreamBuilder<List<ProjectsRecord>>(
                                  stream: queryProjectsRecord(
                                    queryBuilder: (projectsRecord) =>
                                        projectsRecord.where('userAssociation',
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Column(
                                      ...
                                      children: List.generate(
                                          columnProjectsRecordList.length,
                                          (columnIndex) {
                                                              ...
                                                              children: [
                                                                ...
                                                                StreamBuilder<
                                                                  ...
                                                                  stream:
                                                                    ...
                                                                    queryBuilder:
                                                                        (projectsRecord) =>
                                                                            projectsRecord.orderBy('projectLocation'),
                                                                    singleRecord:
                                                                        true,
                                                                  ),
                                                                  builder: (context,
                                                                    ...
                                                                    final textProjectsRecord = textProjectsRecordList
                                                                            .isNotEmpty
                                                                        ? textProjectsRecordList
                                                                            .first
                                                                        : null;
